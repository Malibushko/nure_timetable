...
class LocalStorage : public QObject
{
 ...
 public:
     ...
     * @param isTeacher Boolean flag representing if timetable is teacher timetable or
     * group
     * @param lessons List of lessons in timetable
     * @return QVariant containing SavedTimetable object
     */
    Q_INVOKABLE QVariant createTimetable( int id, QString title, bool isTeacher,
