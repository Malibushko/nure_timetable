...
public:
   ...
   Q_INVOKABLE QVariantList getHideLessons( int id );
   Q_INVOKABLE QVariant     createTimetable( int id, const QVariantList& hideItems );
...
Q_DECLARE_METATYPE( std::vector<timetable::internal::LessonHide> )
